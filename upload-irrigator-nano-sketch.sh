...
# Example:
# bash upload-irrigator-nano-sketch.sh "myIrrigator" ttyUSB0
...
bash upload-device-sketch-arduino.sh "nano" "irrigator" "SoilMoistureSensorCalibratedPump" $DEVICE_NAME $SERIAL_PORT

...
SOIL_MOISTURE_SENSOR_CALIBRATED_SERIAL_LOGS_PUBLISH_PATH="/home/$USER/workspace/GreenSense/Index/public/test-results/SoilMoistureSensorCalibratedSerial/"
mkdir -p $SOIL_MOISTURE_SENSOR_CALIBRATED_SERIAL_LOGS_PUBLISH_PATH
echo "Publishing log to: $SOIL_MOISTURE_SENSOR_CALIBRATED_SERIAL_LOGS_PUBLISH_PATH"
cp $SOIL_MOISTURE_SENSOR_CALIBRATED_SERIAL_LOG_PATH $SOIL_MOISTURE_SENSOR_CALIBRATED_SERIAL_LOGS_PUBLISH_PATH
...
SOIL_MOISTURE_SENSOR_CALIBRATED_PUMP_LOGS_PUBLISH_PATH="/home/$USER/workspace/GreenSense/Index/public/test-results/SoilMoistureSensorCalibratedPump/"
mkdir -p $SOIL_MOISTURE_SENSOR_CALIBRATED_PUMP_LOGS_PUBLISH_PATH
echo "Publishing log to: $SOIL_MOISTURE_SENSOR_CALIBRATED_PUMP_LOGS_PUBLISH_PATH"
cp $SOIL_MOISTURE_SENSOR_CALIBRATED_PUMP_LOG_PATH $SOIL_MOISTURE_SENSOR_CALIBRATED_PUMP_LOGS_PUBLISH_PATH

...
SOIL_MOISTURE_SENSOR_CALIBRATED_SERIAL_LOGS_PUBLISH_PATH="$PWD/public/test-results/SoilMoistureSensorCalibratedSerial/"
...
SOIL_MOISTURE_SENSOR_CALIBRATED_PUMP_LOGS_PUBLISH_PATH="$PWD/public/test-results/SoilMoistureSensorCalibratedPump/"

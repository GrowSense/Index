    ...
    stages {
        ...
        stage('Setup') {
            steps {
                ...
                shHide( 'git clone -b $BRANCH_NAME https://${GHTOKEN}@github.com/GrowSense/Index.git . --reference ../../git-cache/GrowSense/Index.reference' )
                sh 'git submodule update --init --reference ../../git-cache/GrowSense/Index.reference'

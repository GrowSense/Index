...
# Example:
# bash upload-monitor-nano-sketch.sh "mySMMonitor" ttyUSB0
...
bash upload-device-sketch-arduino.sh "nano" "monitor" "SoilMoistureSensorCalibratedSerial" $DEVICE_NAME $SERIAL_PORT

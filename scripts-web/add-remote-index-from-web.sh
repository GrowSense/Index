...
wget -q --no-cache -O - https://raw.githubusercontent.com/GreenSense/Index/$BRANCH/add-remote-index.sh | bash -s -- $REMOTE_NAME $REMOTE_HOST $REMOTE_USERNAME $REMOTE_PASSWORD || exit 1

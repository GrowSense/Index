...
|               | Jenkins Software Test  | [![Build Status](http://greensense.ddns.net:880/job/GreenSense/job/SoilMoistureSensorCalibratedSerial/job/master/badge/icon)](http:/greensense.ddns.net:880/job/GreenSense/job/SoilMoistureSensorCalibratedSerial/job/master/)  | [![Build Status](http://greensense.ddns.net:880/job/GreenSense/job/SoilMoistureSensorCalibratedSerial/job/dev/badge/icon)](http:/greensense.ddns.net:880/job/GreenSense/job/SoilMoistureSensorCalibratedSerial/job/dev/)  |
| **WiFi Monitor**  |               |               |               |

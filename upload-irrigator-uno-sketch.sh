...
# Example:
# bash upload-irrigator-uno-sketch.sh "myIrrigator" ttyUSB0
...
bash upload-device-sketch-arduino.sh "uno" "irrigator" "SoilMoistureSensorCalibratedPump" $DEVICE_NAME $SERIAL_PORT

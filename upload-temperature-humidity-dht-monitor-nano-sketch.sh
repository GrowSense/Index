...
# Example:
# bash upload-temperature-humidity-dht-monitor-nano-sketch.sh "NewTHMonitor" ttyUSB0
...
bash upload-device-sketch-arduino.sh "nano" "monitor" "TemperatureHumidityDHTSensorSerial" $DEVICE_NAME $SERIAL_PORT
